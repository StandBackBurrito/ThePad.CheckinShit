...
using ThePad.ChickenShit.Core.ProjectAggregate.Events;
using ThePad.ChickenShit.Core.ProjectAggregate.Handlers;
using Moq;
using Xunit;

namespace ThePad.ChickenShit.UnitTests.Core.Handlers;
